...
if (isset($_POST['submit'])) {
    try {
        ...
        $cpf = str_replace('-', '', $cpf);
        $cpf = str_replace('.', '', $cpf);
        $sql = $conx->prepare("SELECT * FROM chale.cliente where CPF='$cpf'");
...
<body class="chale">
    <h1 id="txt1">CADASTRO<h1>
            <main class="cliente">
                <form method="POST" action="./incluire.php">
                    <legend>Dados</legend>
                    <div class="row">
                        <div class=" inputbox">
                            <label for="nome">Nome</label>
                            <input type="text" id="nome" value="<?php echo $nome ?>" placeholder="Nome..." name="nome" required>
                        </div>
                        <div class="inputbox">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox">
                            ...
                            <input type="date" id="datai" name="datai" required>
                        </div>
                        <div class="inputbox">
                            <label for="dataf">Saída</label>
                            <input type="date" id="dataf" name="dataf" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="inputbox">
                            ...
                            <select id="chales" name="chales" required>
                                ...
                                ?>
                                    <option value="<?php echo $dados['num_apto'] ?>"><?php echo $dados['num_apto'] ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox">
                            ...
                            <input type="number" id="preço" name="preço" pattern="[\d]{1,6}" title="Necessita do preço" required>
                        </div>
                    </div>
                    <div id="submit">
...
<script type="text/javascript">
    ...
    datai.min = new Date().toISOString().split("T")[0];
