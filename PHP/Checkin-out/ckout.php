        ...
        <div class=" w-auto ml-5 mr-5 pt-2 pb-2 text-center">
            <table class="table">
                ...
                <tbody>
                    ...
                    try {
                        $situação = "Fechado";
                        $sql = $conx->prepare("SELECT * FROM chale.reserva where situação='$situação' order by id ");
                        $sql->execute();
                        $query = $sql->fetchAll();
                        foreach ($query as $key => $value) {
                            ...
                            echo "<td>
                                    <a href='../reserva/viewre.php?id=" . $value['id'] . "'  name='btnView'  class='btn btn-secondary'>Detalhes</a></td>";
                            echo "</tr>";
                        }
