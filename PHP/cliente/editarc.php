...
<body>
    ...
    <main class="cliente">
        <form method="POST" action='./updatec.php?CPF=<?php echo $cpf2 ?>'>
            <legend>Dados Pessoais</legend>
            <div class="row">
                <div class="inputbox">
                    <label for="nome">Nome</label>
                    <input type="text" id="nome" placeholder="Nome..." pattern="[A-Za-zÀ-ú ]{1,50}" maxlength="50" name="nome" value="<?php echo $nome ?>" required>

                </div>
                <div class="inputbox">
                    <label for="tel">Telefone</label>
                    <input type="text" id="tel" placeholder="(12)93456-7890" value="<?php echo $tel ?>" pattern="(\d{2})[9]{1}[\d]{4}-[\d]{4})" title="Insira o formato correto de telefone celular..." name="tel" required>
            ...
            <div class="row">
                <div class="inputbox">
                    ...
                    <input type="text" id="emailc" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" maxlength="50" value="<?php echo $email ?>" placeholder="Email..." name="email" required>

                </div>
                <div class="inputbox">
                    <label for="CPF">CPF</label>
                    <input type="text" id="CPF" placeholder="123.456.789-01" value="<?php echo $CPF ?>" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Insira o Formato Correto" name="CPF" required>
            ...
            <div class="row">
                <div class="inputbox">
                    ...
                    <input type="text" id="CEP" placeholder="12345-678" pattern="\d{5}-?\d{3}" maxlength="8" title="Insira o formato correto do CEP" name="CEP" value="<?php echo $cep ?>" required>

                </div>
                <div class="inputbox">
                    <label for="rua">Rua</label>
                    <input type="text" id="rua" name="rua" pattern="[A-Za-zÀ-ú ]{1,50}" title="Digite a Rua" value="<?php echo $rua ?>" required>
            ...
            <div class="row">
                <div class="inputbox">
                    ...
                    <input type="text" id="num" pattern="\d*" maxlength="5" title="Insira pelo menos um número" size="10" name="num" value="<?php echo $num ?>" required>
                </div>
                <div class="inputbox">
                    <label for="bairro">Bairro</label>
                    <input type="text" id="bairro" pattern="[A-Za-zÀ-ú ]{1,50}" title="Digite o Bairro" name="bairro" value="<?php echo $bairro ?>" required>
            ...
            <div class="row">
                <div class="inputbox">
                    ...
                    <input type="text" id="cidade" name="cidade" pattern="[A-Za-zÀ-ú ]{1,50}" value="<?php echo $cidade ?>" required>
                </div>
                <div class="inputbox">
            ...
            <div class="row">
                <div class="inputbox">
                    ...
                    <input type="text" id="complemento" name="complemento" maxlength="50" value="<?php echo $complemento ?>">
                </div>
            </div>

            <input type="submit" id="submit" value="Editar" name="btnEdita" onclick="confirm('Deseja realmente editar os dados?')">
